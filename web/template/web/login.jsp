...
<div class="dowebok" id="dowebok">
    <div class="form-container sign-up-container">
        <form action="#" style="display: none" id="addForm">
            <h2 class="title_href" onclick="window.location.href = 'home'">果蔬超市</h2>
            <h3 style="margin-top: 0px">注册</h3>
            <input type="text" placeholder="用户名" name="registerName" autocomplete="off">
            <input type="password" name="registerPassword" placeholder="密码" autocomplete="new-password">
            <div>
        ...
        <form action="#" style="display: none" id="editForm">
            ...
            <input type="text" placeholder="用户名" name="forgetName" autocomplete="off">
            <input type="text" placeholder="原密码" name="oldPassword" autocomplete="off">
            <input type="password" name="newPassword" placeholder="设置新密码" autocomplete="new-password">
            <div>
    ...
    <div class="form-container sign-in-container">
            <form action="loginIn" id="loginForm">
            <h2 class="title_href" onclick="window.location.href = '/tmall'">果蔬超市</h2>
