			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a class="organik-btn arrow" href="shop">前往购物</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="row" style="margin-top: 40px">
							...
							<div class="col-md-3 col-sm-6 product-item masonry-item text-center vegetables">
									...
									<c:if test="${item.stock > 0}">
										<div class="product-action">
											...
											<span class="quickview">
												<a href="product?pid=${item.id}" data-toggle="tooltip" data-placement="top" title="查看详细"></a>
											</span>
										</div>
									</c:if>
								</div>
								<div class="product-info">
									<a href="shop-detail.jsp">
										...
										<span class="price<c:if test="${item.originalPrice != null}"> delPrice</c:if>">¥${item.nowPrice}</span>
										<c:if test="${item.originalPrice != null}"><span class="price">¥${item.originalPrice}</span></c:if>
									</a>
								</div>
							</div>
						</c:forEach>
					...
					<div class="loadmore-contain">
						<a class="organik-btn small" href="shop"> 查看更多 </a>
					</div>
				</div>
			</div>
        </div>
